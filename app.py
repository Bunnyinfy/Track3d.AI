...
def display_cost_analysis():
    ...
    if not st.session_state.selected_materials:
        ...
        st.number_input(
            ...
            step=10.0,
            key="project_area",
            on_change=lambda: setattr(st.session_state, 'project_area', st.session_state.project_area)
        )
...
def display_help():
    ...
    - Email: support@constructionmaterial.ai
    - Phone: (123) 456-7890
    - Website: www.constructionmaterial.ai
    """)
...
def main():
    ...
    # Show app header
    st.markdown('<div class="main-header">🏗️ Construction Material Recommendation System</div>', unsafe_allow_html=True)
    st.markdown('<div class="sub-header">AI-powered material selection for construction projects</div>', unsafe_allow_html=True)
