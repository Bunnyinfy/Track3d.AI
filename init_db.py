    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            if materials_count == 0:
                ...
                print(f"Materials table already has {materials_count} records. Skipping material data insertion.")
        ...
        with engine.connect() as conn:
            ...
            if suppliers_count == 0:
                ...
                print(f"Suppliers table already has {suppliers_count} records. Skipping supplier data insertion.")
